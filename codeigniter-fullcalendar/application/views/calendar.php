...
if ($this->session->userdata('login_function')) {
    // If logged in, retrieve the username from the session
    $username = $this->session->userdata('username');
} else {
    // If not logged in, set a default message
...
<nav class="navbar navbar-default">
    <div class="container">
        <div class="navbar-header">
            <a href="<?php echo site_url('calendar'); ?>" class="navbar-brand">Scheduler</a>
        </div>
        <ul class="nav navbar-nav navbar-right">
            <?php if ($this->session->userdata('login_function')): ?>
                <!-- If user is logged in, show the user dropdown -->
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="fas fa-user"></i> <?php echo $username; ?> <i class="fas fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu user-dropdown">
                        <li><a href="<?php echo site_url('login/logout_function'); ?>">Logout</a></li>
            ...
            <?php else: ?>
                ...
                <li>
                    <button type="button" class="btn btn-link navbar-btn" data-toggle="modal" data-target="#loginModal">
                        Login
                    </button>
                </li>
            <?php endif; ?>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <!-- Example: -->
                                                    <?php echo form_open('login/login_function'); ?>
    ...
    <script>
        // Show/hide user dropdown on click
        $(document).ready(function(){
